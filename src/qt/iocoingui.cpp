    ...
    nWeight(0)
{
    ...
    QString svgtr; 
    QFile qssFiletr(":/icons/dragtopright");
    qssFiletr.open(QFile::ReadOnly);
    svgtr = QLatin1String(qssFiletr.readAll());
    ...
    QString svgbl; 
    QFile qssFilebl(":/icons/dragbottomleft");
    qssFilebl.open(QFile::ReadOnly);
    svgbl = QLatin1String(qssFilebl.readAll());
