...
bool Client::init()
{
	std::cout << "nool Client::init" << std::endl;
#ifdef _MSC_VER
...
#define PROCESS_DEP_ENABLE 0x00000001
  ...
  catch (boost::exception const& ex)
  {
    if (dev::db::isDiskDatabase())
    {
      ...
      {
        return InitError_("Insufficient disk space : "
      ...
      {
        return InitError_("Database already open. You appear to have "
...
#endif
  std::cout << "Exit bool Client::init" << std::endl;
  return true;
}
