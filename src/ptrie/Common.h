...
{
public:
  InvariantChecker(HasInvariants* _this, char const* _fn, char const* _file, int _line): m_this(_this), m_function(_fn), m_file(_file), m_line(_line)
  {
...
#define DEV_TIMED(S) for (::std::pair<::dev::TimerHelper, bool> __dvm_t(S, true); __dvm_t.second; __dvm_t.second = false)
#define DEV_TIMED_SCOPE(S) ::dev::TimerHelper __dvm_t(S)
#if defined(_WIN32)
...
#define DEV_TIMED_ABOVE(S,MS) for (::std::pair<::dev::TimerHelper, bool> __dvm_t(::dev::TimerHelper(S, MS), true); __dvm_t.second; __dvm_t.second = false)
#define DEV_TIMED_SCOPE_ABOVE(S,MS) ::dev::TimerHelper __dvm_t(S, MS)
#if defined(_WIN32)
