...
//XXXX #include "MemoryDB.h"
//XXXX #include "libethcore/Exceptions.h"
...
void setDatabaseKindByName(std::string const& _name)
{
    ...
    //XXXX BOOST_THROW_EXCEPTION(
    //XXXX    eth::InvalidDatabaseKind() << errinfo_comment("invalid database name supplied: " + _name));
}
