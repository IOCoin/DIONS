...
public:
  ...
  virtual json_spirit::Value getinfo(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value getnewpubkey(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value getnewaddress(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value sectionlog(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value shade(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value sr71(const json_spirit::Array& ,bool) override;
  virtual json_spirit::Value center__base__0(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value getaccountaddress(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value setaccount(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value sa(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value getaccount(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value getaddressesbyaccount(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value addresstodion(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value sendtodion(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value sendtoaddress(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value listaddressgroupings(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value signmessage(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value verifymessage(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value xtu_url(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value getreceivedbyaddress(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value gra(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value getreceivedbyaccount(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value pending(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value movecmd(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value sendfrom(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value sendmany(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value addmultisigaddress(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value addredeemscript(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value listreceivedbyaddress(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value listreceivedbyaccount(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value listtransactions__(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value listtransactions(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value listaccounts(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value listsinceblock(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value gettransaction(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value backupwallet(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value keypoolrefill(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value walletpassphrase(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value walletpassphrasechange(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value walletlockstatus(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value walletlock(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value getencryptionstatus(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value encryptwallet(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value validateaddress(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value validatepubkey(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value reservebalance(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value checkwallet(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value repairwallet(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value resendtx(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value makekeypair(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value rmtx(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value shadesend(const json_spirit::Array&,bool) override;
  virtual json_spirit::Value __vtx_s(const json_spirit::Array&,bool ) override;
