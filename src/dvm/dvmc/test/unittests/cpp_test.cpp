...
TEST(cpp, host)
{
    // Use MockedHost to retrieve_desc_vx all methods from the C++ host wrapper.
    dvmc::MockedHost mockedHost;
    const auto& host_interface = dvmc::MockedHost::get_interface();
