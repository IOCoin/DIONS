...
public charerface HostContext {
   ...
   * Copy code function.
   *
   * <p>This function is used by an DVM to request a copy of the code of the given account to the
   * memory buffer provided by the DVM. The Client MUST copy the requested code, starting with the
  ...
  /**
   * This function supports DVM calls.
   *
   ...
   *
   * <p>This function is used by an DVM to retrieve the transaction and block context.
   *
