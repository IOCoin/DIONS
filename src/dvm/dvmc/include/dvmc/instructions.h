...
/**
 * DVM Instruction Tables
 *
 * A collection of metrics for DVM1 instruction set.
 *
 * @defgroup instructions DVM Instructions
 * @{
 */
#pragma once
...
/**
 * The list of DVM 1 opcodes from every DVM revision.
 */
enum dvmc_opcode
{
    OP_STOP = 0x00,
