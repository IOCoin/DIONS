...
- Adjustments to `dvmc::mocked_host`: storage changes to non-existent keys are now preserved.
...
- Added `MockedHost` C++ class (in form of header-only `dvmc::mocked_host` library)
