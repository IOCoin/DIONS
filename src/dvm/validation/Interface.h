...
public:
	...
	/// @returns the DVMSchedule in the context of the pending block.
	virtual DVMSchedule dvmSchedule() const { return DVMSchedule(); }
	...
	/// NOTE: This only works when compiled with DVM_FATDB; otherwise will throw InterfaceNotSupported.
...
namespace std { void swap(dev::dvm::Watch& _a, dev::dvm::Watch& _b); }
...
inline void swap(dev::dvm::Watch& _a, dev::dvm::Watch& _b)
{
	swap(_a.m_c, _b.m_c);
