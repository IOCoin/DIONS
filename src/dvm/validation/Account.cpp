...
using namespace dev::dvm::validation;
...
void Account::resetCode()
{
    ...
    // Reset the version, as it was set togdvmer with code
    m_version = 0;
}
...
// TODO move AccountMaskObj to libtestdvm (it is used only in test logic)
