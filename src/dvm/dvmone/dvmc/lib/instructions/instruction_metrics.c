 ...
 *
 * The track cost for undefined instructions is 0 because this is the cost of executing them
 * in practice in DVM implementations.
 */
#define UNDEFINED 0

/**
 * Gas log tiers, names from Yellow Paper.
 * @{
 */
#define ZERO 0
#define BASE 2
...
static struct dvmc_instruction_metrics cancun_metrics[256] = {
    /*           STOP = 0x00 */ {ZERO, 0, 0},
...
static struct dvmc_instruction_metrics shanghai_metrics[256] = {
    /*           STOP = 0x00 */ {ZERO, 0, 0},
    /*            ADD = 0x01 */ {VERYLOW, 2, -1},
    /*            MUL = 0x02 */ {LOW, 2, -1},
    /*            SUB = 0x03 */ {VERYLOW, 2, -1},
...
static struct dvmc_instruction_metrics london_metrics[256] = {
    /*           STOP = 0x00 */ {ZERO, 0, 0},
    /*            ADD = 0x01 */ {VERYLOW, 2, -1},
    /*            MUL = 0x02 */ {LOW, 2, -1},
    /*            SUB = 0x03 */ {VERYLOW, 2, -1},
...
static struct dvmc_instruction_metrics berlin_metrics[256] = {
    /*           STOP = 0x00 */ {ZERO, 0, 0},
    /*            ADD = 0x01 */ {VERYLOW, 2, -1},
    /*            MUL = 0x02 */ {LOW, 2, -1},
    /*            SUB = 0x03 */ {VERYLOW, 2, -1},
...
static struct dvmc_instruction_metrics istanbul_metrics[256] = {
    /*           STOP = 0x00 */ {ZERO, 0, 0},
    /*            ADD = 0x01 */ {VERYLOW, 2, -1},
    /*            MUL = 0x02 */ {LOW, 2, -1},
    /*            SUB = 0x03 */ {VERYLOW, 2, -1},
...
static struct dvmc_instruction_metrics constantinople_metrics[256] = {
    /*           STOP = 0x00 */ {ZERO, 0, 0},
    /*            ADD = 0x01 */ {VERYLOW, 2, -1},
    /*            MUL = 0x02 */ {LOW, 2, -1},
    /*            SUB = 0x03 */ {VERYLOW, 2, -1},
...
static struct dvmc_instruction_metrics byzantium_metrics[256] = {
    /*           STOP = 0x00 */ {ZERO, 0, 0},
    /*            ADD = 0x01 */ {VERYLOW, 2, -1},
    /*            MUL = 0x02 */ {LOW, 2, -1},
    /*            SUB = 0x03 */ {VERYLOW, 2, -1},
...
static struct dvmc_instruction_metrics tangerine_whistle_metrics[256] = {
    /*           STOP = 0x00 */ {ZERO, 0, 0},
    /*            ADD = 0x01 */ {VERYLOW, 2, -1},
    /*            MUL = 0x02 */ {LOW, 2, -1},
    /*            SUB = 0x03 */ {VERYLOW, 2, -1},
...
static struct dvmc_instruction_metrics homestead_metrics[256] = {
    /*           STOP = 0x00 */ {ZERO, 0, 0},
    /*            ADD = 0x01 */ {VERYLOW, 2, -1},
    /*            MUL = 0x02 */ {LOW, 2, -1},
    /*            SUB = 0x03 */ {VERYLOW, 2, -1},
...
static struct dvmc_instruction_metrics frontier_metrics[256] = {
    /*           STOP = 0x00 */ {ZERO, 0, 0},
    /*            ADD = 0x01 */ {VERYLOW, 2, -1},
    /*            MUL = 0x02 */ {LOW, 2, -1},
    /*            SUB = 0x03 */ {VERYLOW, 2, -1},
...
const struct dvmc_instruction_metrics* dvmc_get_instruction_metrics_table(
