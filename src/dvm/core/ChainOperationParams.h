...
#include <libdvmcore/Precompiled.h>
...
struct ChainOperationParams
{
    ...
    /// The chain validationer name: e.g. DVMash, NoProof, BasicAuthority
    std::string validationEngineName = "NoProof";

    // Example of how to check EIP activation from outside of DVM:
...
public:
    ...
    DVMSchedule const& scheduleForBlockNumber(u256 const& _blockNumber) const;
    ...
    DVMSchedule const& forkScheduleForBlockNumber(u256 const& _blockNumber) const;
    u256 blockReward(DVMSchedule const& _schedule) const;
    ...
    DVMSchedule lastForkWithAdditionalEIPsSchedule;
};
