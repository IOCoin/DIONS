...
DVMSchedule const& ChainOperationParams::scheduleForBlockNumber(u256 const& _blockNumber) const
{
...
DVMSchedule const& ChainOperationParams::forkScheduleForBlockNumber(u256 const& _blockNumber) const
{
...
u256 ChainOperationParams::blockReward(DVMSchedule const& _schedule) const
{
