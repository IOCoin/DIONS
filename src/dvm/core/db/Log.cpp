...
auto const g_timestampFormatter =
    (boost::log::expressions::stream
        << DVMViolet << boost::log::expressions::format_date_time(timestamp, "%m-%d %H:%M:%S")
        << DVMReset " ");
