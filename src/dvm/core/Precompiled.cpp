...
DVM_REGISTER_PRECOMPILED_PRICER(ecrecover)
(bytesConstRef /*_in*/, ChainOperationParams const& /*_chainParams*/, u256 const& /*_blockNumber*/)
{
    return 3000;
}

DVM_REGISTER_PRECOMPILED(ecrecover)(bytesConstRef _in)
{
    struct
    {
        h256 hash;
...
DVM_REGISTER_PRECOMPILED_PRICER(sha256)
(bytesConstRef _in, ChainOperationParams const& /*_chainParams*/, u256 const& /*_blockNumber*/)
{
    return linearPricer(60, 12, _in);
}

DVM_REGISTER_PRECOMPILED(sha256)(bytesConstRef _in)
{
    return {true, dev::sha256(_in).asBytes()};
}

DVM_REGISTER_PRECOMPILED_PRICER(ripemd160)
(bytesConstRef _in, ChainOperationParams const& /*_chainParams*/, u256 const& /*_blockNumber*/)
{
    return linearPricer(600, 120, _in);
}

DVM_REGISTER_PRECOMPILED(ripemd160)(bytesConstRef _in)
{
    return {true, h256(dev::ripemd160(_in), h256::AlignRight).asBytes()};
}

DVM_REGISTER_PRECOMPILED_PRICER(identity)
(bytesConstRef _in, ChainOperationParams const& /*_chainParams*/, u256 const& /*_blockNumber*/)
{
    return linearPricer(15, 3, _in);
}

DVM_REGISTER_PRECOMPILED(identity)(bytesConstRef _in)
{
...
DVM_REGISTER_PRECOMPILED(modexp)(bytesConstRef _in)
{
...
DVM_REGISTER_PRECOMPILED_PRICER(modexp)(bytesConstRef _in, ChainOperationParams const&, u256 const&)
{
    bigint const baseLength(parseBigEndianRightPadded(_in, 0, 32));
    bigint const expLength(parseBigEndianRightPadded(_in, 32, 32));
    bigint const modLength(parseBigEndianRightPadded(_in, 64, 32));
...
DVM_REGISTER_PRECOMPILED(alt_bn128_G1_add)(bytesConstRef _in)
{
    return dev::crypto::alt_bn128_G1_add(_in);
}

DVM_REGISTER_PRECOMPILED_PRICER(alt_bn128_G1_add)
(bytesConstRef /*_in*/, ChainOperationParams const& _chainParams, u256 const& _blockNumber)
{
    return _blockNumber < _chainParams.istanbulForkBlock ? 500 : 150;
}

DVM_REGISTER_PRECOMPILED(alt_bn128_G1_mul)(bytesConstRef _in)
{
    return dev::crypto::alt_bn128_G1_mul(_in);
}

DVM_REGISTER_PRECOMPILED_PRICER(alt_bn128_G1_mul)
(bytesConstRef /*_in*/, ChainOperationParams const& _chainParams, u256 const& _blockNumber)
{
    return _blockNumber < _chainParams.istanbulForkBlock ? 40000 : 6000;
}

DVM_REGISTER_PRECOMPILED(alt_bn128_pairing_product)(bytesConstRef _in)
{
    return dev::crypto::alt_bn128_pairing_product(_in);
}

DVM_REGISTER_PRECOMPILED_PRICER(alt_bn128_pairing_product)
(bytesConstRef _in, ChainOperationParams const& _chainParams, u256 const& _blockNumber)
{
...
DVM_REGISTER_PRECOMPILED(blake2_compression)(bytesConstRef _in)
{
...
DVM_REGISTER_PRECOMPILED_PRICER(blake2_compression)
