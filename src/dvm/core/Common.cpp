// Aldvm: DVMereum C++ client, tools and libraries.
// Copyright 2013-2019 Aldvm Authors.
...
{
	string const c_line = DVMReset DVMOnMaroon + string(80, ' ') + DVMReset;
	string const c_border = DVMReset DVMOnMaroon + string(2, ' ') + DVMReset DVMMaroonBold;
	string const c_space = c_border + string(76, ' ') + c_border + DVMReset;
	stringstream ss;
	ss << c_line << "\n";
	ss << c_space << "\n";
