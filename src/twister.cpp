...
const int transition_seq[] = { 0xce, 0xab, 0xdf, 0xcf, 0xee,
                               ...
                               0xe0, 0x10, 0x9f, 0xe1, 0xc6, 
                               0x19, 0x05, 0x81, 0xf0, 0xee, 
...
int ENTRY_C_OUTER_PROD_TEST = 0x23;
int ENTRY_C_OUTER_PROD_TOR_TEST = 0xfd;
int ENTRY_A_OUTER_PROD_TOR_TEST = 0xc9;
int ENTRY_B_OUTER_PROD_EUC_TEST = 0xaf;
int ENTRY_C_OUTER_PROD_EUC_TEST = 0xa1;
int ENTRY_C_INNER_PROD_EUC_TEST = 0xca;
int ENTRY_C_INNER_PROD_ELIP_TEST = 0xca;
